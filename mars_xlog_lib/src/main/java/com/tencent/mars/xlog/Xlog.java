...
import com.cxyzy.mars_xlog_lib.BuildConfig;

class Xlog implements FileLog.LogImp {
    ...
    public static void open(String cacheDir, String logDir, String namePrefix, String pubKey) {
        System.loadLibrary("stlport_shared");
        System.loadLibrary("marsxlog");
        Xlog.appenderOpen(Xlog.LEVEL_DEBUG, Xlog.AppednerModeAsync, cacheDir, logDir, namePrefix, pubKey);
